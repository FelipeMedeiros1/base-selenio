# language: pt
@crud
Funcionalidade: Esta funcionalidade testa as operações CRUD (Criar, Consultar, Atualizar e Excluir)
  ...
  Esquema do Cenário: Realizar inclusão, consulta, atualização e exclusão
    ...
    Então verifica a mensagem pelo tipo de operação "<operacao>"
