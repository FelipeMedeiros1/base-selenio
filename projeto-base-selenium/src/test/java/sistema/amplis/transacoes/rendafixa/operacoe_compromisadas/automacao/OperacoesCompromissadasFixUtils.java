...
public class OperacoesCompromissadasFixUtils extends UtilitarioCadastro<OperacoesCompromissadas> {
    ...
    @Override
    public OperacoesCompromissadasFixUtils incluir(OperacoesCompromissadas dados, int posicao) {
        acessaPagina();
        inserir();
...
//        preenche(pagina.consulta().carteiraConsulta, dados.carteiraConsulta());
    ...
    @Override
    public OperacoesCompromissadasFixUtils atualizar(OperacoesCompromissadas dados, int posicao) {
        return this;
    }

    @Override
    public void excluir(OperacoesCompromissadas dados, int posicao) {
