...
Funcionalidade:  Esta funcionalidade testa as operação Inclusão de uma movimentação no sistema.
  ...
  Cenário: Realizar a inclusão de uma movimentação de Operacoes Definitivas no sistema
    ...
    Dado que o usuário acesse a página "Transações > Renda Fixa > Movimentação > Operações Definitivas".
    ...
    Então a nova operação deverá ser incluída com sucesso no sistema devolvendo a mensagem "Operação realizada com sucesso."
