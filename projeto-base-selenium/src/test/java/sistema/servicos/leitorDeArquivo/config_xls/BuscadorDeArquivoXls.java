package sistema.servicos.leitorDeArquivo.config_xls;
...
public class BuscadorDeArquivoXls {
    static Path caminhoCompleto = null;
    public static Path encontrarCaminhoDoArquivo(String nomeArquivo) throws IOException {
        Path diretorioInicial = Paths.get("C:\\Users\\felipem.medeiros\\Documents\\cursos\\SELENIUM\\base-selenio\\projeto-base-selenium\\src\\test\\java"); // Substitua pelo seu diretório inicial
    ...
    public static void main(String[] args) {
        try {
            String nomeArquivo = "MoedasTest.xlsx";
